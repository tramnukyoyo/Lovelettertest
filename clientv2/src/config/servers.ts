/**
 * Multi-region server configuration for GameBuddies Template
 *
 * NOTE: When creating a new game from this template, update GAME_NAMESPACE
 * to match your game's namespace in the server plugin.
 */
 ...
 * `/.proxy/gs` (Discord strips `/gs` → shared gameserver). The `/bluffalo` namespace
