...
export const ptPT: Translations = {
  ...
  home: {
    ...
    formNote: 'Assina o processo para o desbloquear',
  ...
  // AI-TRANSLATED on 2026-05-19, please review
  errorBoundary: {
    title: 'O processo rasgou-se',
    message: 'Algo na sala de provas avariou-se.',
    overline: 'Sala de provas',
  ...
  playerList: {
    ...
    removing: 'A remover...',
    returnedToLobby: 'Voltou ao lobby do GameBuddies',
    ...
    frameLabel: 'Moldura',
    frameNone: 'Nenhuma',
    previewUnlockHint: 'Só pré-visualização — desbloqueia no designer',
  },

  designer: {
    title: 'O teu estilo',
    cardBackTitle: 'O verso da tua carta',
    classic: 'Nenhum',
    framesTitle: 'Moldura de avatar',
    framesHint: 'contorna o teu avatar aqui e no GameBuddies',
    flairsTitle: 'Estilo de nome',
    flairsHint: 'colore o teu nome onde quer que jogues',
    premiumIncluded: 'Premium — está tudo incluído para ti.',
    premiumExclusive: 'Exclusivo do Premium — vem com o Premium, não com GP.',
    playerCardCaption: 'O teu cartão de jogador',
    yourGp: 'Os teus Gabu Points',
    price: 'Preço',
    ...
    foreverEverywhere: '{name} é teu para sempre — no GameBuddies e em todos os jogos.',
    equipped: 'EQUIPADO',
  ...
  videoControl: {
    ...
    reactions: 'Reações',
    pttLive: 'Em direto',
    premiumLockTooltip: 'Desbloqueia com o GameBuddies Premium',
    packSpicy: 'Picante',
    packWholesome: 'Fofo',
  },
  ...
  premiumUpsell: {
    ...
    tryTrial: 'Testa o Premium com Pontos Gabu',
  },
  ...
  errors: {
    ...
    contentFilterBody: 'Bloqueado pelo filtro de conteudo, tenta outras palavras.',
    serverRejectedTitle: 'O processo foi rejeitado',
  },
  ...
  installPrompt: {
    title: 'Instalar jogo',
    iosSubtitle: 'Desfruta da experiência em ecrã inteiro!',
    androidSubtitle: 'Adiciona ao ecrã inicial para jogar em ecrã inteiro!',
    iosStep1Prefix: 'Toca no',
    iosStep1Suffix: 'botão Partilhar abaixo',
    iosStep2: 'Desliza e toca em «Adicionar ao ecrã principal»',
    iosStep3: 'Toca em «Adicionar» para instalar',
    installApp: 'Instalar app',
    dontShowAgain: 'Não mostrar novamente',
  },
  portalClose: {
    returningCountdown: 'A voltar ao GameBuddies em {countdown} segundos',
    returningEveryone: 'A levar todos de volta à sala...',
    returningToGameBuddies: 'A voltar ao GameBuddies...',
  },
  loadingScreen: {
    connecting: 'A ligar',
    hint1: 'Prepara-te para jogar!',
    hint2: 'Junta os teus amigos!',
    hint3: 'A diversão está prestes a começar!',
    hint4: 'A carregar uma jogabilidade incrível...',
    hint5: 'A preparar a sala de jogo!',
    hint6: 'Quase lá!',
  },
  heartsGambit: {
    cardValue: 'Valor:',
  ...
  gameAd: {
    support: 'Apoia o GameBuddies',
    helpKeepFree: 'A publicidade mantém os jogos gratuitos!',
  },
  psDemo: {
  ...
  xp: {
    ...
    win: 'Vitória',
    length: 'duração',
    streak: '{count} de série',
    firstWin: 'Primeira vitória',
    xpBoost: 'Bónus de XP 2×',
    lv: 'Nv',
  ...
  adminMessage: {
    ...
    unreadTitle: '{count} por ler',
    close: 'Fechar',
    dragHint: 'Arrasta para mover',
    newMessageHint: 'Clica para abrir',
    loading: 'A carregar…',
    empty: 'Ainda sem mensagens — diz olá e a equipa GameBuddies responde.',
    unavailable: 'As mensagens estão indisponíveis de momento. O teu histórico está seguro.',
    retry: 'Tentar de novo',
    fromTeam: 'Equipa GameBuddies',
    you: 'Tu',
    replyPlaceholder: 'Escreve uma resposta…',
    firstMessagePlaceholder: 'Escreve a tua mensagem…',
    send: 'Enviar',
    sendFailed: 'Não enviado — toca para tentar de novo',
  },
  mute: {
    mute: 'Silenciar',
    unmute: 'Ativar som',
