...
export const es: Translations = {
  ...
  home: {
    ...
    formNote: 'Firma el expediente para desbloquearlo',
  ...
  playerList: {
    ...
    removing: 'Eliminando...',
    signInToBuyStyles: 'Inicia sesión para comprar estilos con Gabu Points',
    buyStyleInDesigner: "Desbloquéalo en 'Tu estilo' con Gabu Points",
    kick: 'Expulsar',
    ...
    frameLabel: 'Marco',
    frameNone: 'Ninguno',
    previewUnlockHint: 'Solo vista previa — desbloquéalo en el diseñador',
  },
  ...
  designer: {
    ...
    flairsTitle: 'Estilo de nombre',
    flairsHint: 'colorea tu nombre dondequiera que juegues',
    premiumIncluded: 'Premium — todo está incluido para ti.',
    premiumExclusive: 'Exclusivo de Premium — viene con Premium, no con GP.',
    playerCardCaption: 'Tu tarjeta de jugador',
    yourGp: 'Tus Gabu Points',
    price: 'Precio',
    afterPurchase: 'Tras la compra',
    gpShort: 'Faltan {gp} GP',
    buy: 'Comprar',
  ...
  adminMessage: {
    title: 'Mensajes',
    dialogLabel: 'Mensajes',
    buttonLabel: 'Mensajes',
    unreadTitle: '{count} sin leer',
    close: 'Cerrar',
    dragHint: 'Arrastra para mover',
    newMessageHint: 'Haz clic para abrir',
    loading: 'Cargando…',
    empty: 'Aún no hay mensajes: saluda y el equipo de GameBuddies te responderá.',
    unavailable: 'Los mensajes no están disponibles ahora mismo. Tu historial está a salvo.',
    retry: 'Reintentar',
    fromTeam: 'Equipo de GameBuddies',
    you: 'Tú',
    replyPlaceholder: 'Escribe una respuesta…',
    firstMessagePlaceholder: 'Escribe tu mensaje…',
    send: 'Enviar',
    sendFailed: 'No enviado: toca para reintentar',
  },
  mute: {
    mute: 'Silenciar',
