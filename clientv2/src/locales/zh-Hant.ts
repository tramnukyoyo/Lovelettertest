...
export const zhHant: Translations = {
  ...
  playerList: {
    ...
    removing: '移除中...',
    returnedToLobby: '已返回 GameBuddies 大廳',
    ...
    frameLabel: '頭像框',
    frameNone: '無',
    previewUnlockHint: '僅供預覽——請在設計器中解鎖',
  },
  ...
  designer: {
    ...
    flairsTitle: '名字特效',
    flairsHint: '在你遊玩的每個地方為名字上色',
    premiumIncluded: 'Premium——所有內容都已包含。',
    premiumExclusive: 'Premium 專屬——隨 Premium 附贈，無法用 GP 購買。',
    playerCardCaption: '你的玩家卡',
    yourGp: '你的 Gabu Points',
    price: '價格',
    afterPurchase: '購買後',
    gpShort: '還差 {gp} GP',
    buy: '購買',
  ...
  adminMessage: {
    ...
    dialogLabel: '訊息',
    buttonLabel: '訊息',
    unreadTitle: '{count} 則未讀',
    close: '關閉',
    dragHint: '拖曳以移動',
    newMessageHint: '點擊開啟',
    loading: '載入中…',
    empty: '目前沒有訊息 — 打聲招呼，GameBuddies 團隊會回覆你。',
    unavailable: '訊息目前無法使用。你的紀錄仍然安全。',
    retry: '重試',
    fromTeam: 'GameBuddies 團隊',
    you: '你',
    replyPlaceholder: '輸入回覆…',
    firstMessagePlaceholder: '輸入你的訊息…',
    send: '傳送',
    sendFailed: '未送出 — 點擊重試',
  },
  mute: {
