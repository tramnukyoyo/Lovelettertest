...
export const de: Translations = {
  ...
  playerList: {
    ...
    frameLabel: 'Rahmen',
    frameNone: 'Keiner',
    previewUnlockHint: 'Nur Vorschau — freischalten im Designer',
  },

  designer: {
    title: 'Dein Style',
    cardBackTitle: 'Deine Kartenrückseite',
    classic: 'Keiner',
    framesTitle: 'Avatar-Rahmen',
    framesHint: 'umrahmt deinen Avatar hier und auf GameBuddies',
    flairsTitle: 'Namens-Flair',
    flairsHint: 'färbt deinen Namen überall, wo du spielst',
    premiumIncluded: 'Premium — für dich ist alles enthalten.',
    premiumExclusive: 'Ein Premium-Exklusiv — gibt es mit Premium statt für GP.',
    playerCardCaption: 'Deine Spielerkarte',
    yourGp: 'Deine Gabu Points',
    price: 'Preis',
    afterPurchase: 'Nach dem Kauf',
    gpShort: '{gp} GP fehlen',
    buy: 'Kaufen',
    buyQuestion: '{name} kaufen?',
    buying: 'Wird gekauft…',
    buyFor: 'Kaufen · {gp} GP',
  ...
  adminMessage: {
    title: 'Nachrichten',
    dialogLabel: 'Nachrichten',
    buttonLabel: 'Nachrichten',
    unreadTitle: '{count} ungelesen',
    close: 'Schließen',
    dragHint: 'Zum Verschieben ziehen',
    newMessageHint: 'Zum Öffnen klicken',
    loading: 'Wird geladen…',
    empty: 'Noch keine Nachrichten – schreib Hallo und das GameBuddies-Team meldet sich.',
    unavailable: 'Nachrichten sind gerade nicht verfügbar. Dein Verlauf ist sicher.',
    retry: 'Erneut versuchen',
    fromTeam: 'GameBuddies-Team',
    you: 'Du',
    replyPlaceholder: 'Antwort schreiben…',
    firstMessagePlaceholder: 'Deine Nachricht…',
    send: 'Senden',
    sendFailed: 'Nicht gesendet – zum Wiederholen tippen',
  },
  mute: {
    mute: 'Stummschalten',
