/**
 * Streamer Settings Panel — Prime Suspect
 *
 * Simplified single-layout settings with overlay toggles.
 * Follows the Canvas Chaos / DDF pattern: no layout cards, just toggle switches.
 */
